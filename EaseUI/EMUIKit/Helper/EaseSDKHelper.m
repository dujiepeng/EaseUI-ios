...
{
    NSMutableDictionary* tmpDic = [[NSMutableDictionary alloc] initWithDictionary:messageExt];
    [tmpDic setObject:@{@"visitor":@{@"userNickname":[EaseSDKHelper shareHelper].deviceInfo, @"description":[EaseSDKHelper shareHelper].userDescription}} forKey:@"weichat"];
    
    return [self sendImageMessageWithImage:image to:to messageType:messageType requireEncryption:requireEncryption messageExt:tmpDic quality:0.6 progress:progress];
}
